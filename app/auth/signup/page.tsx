...
export default function SignUp() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast("Account created! You have successfully registered. Please sign in.")

      router.push("/auth/signin")
    } catch (error) {
      toast(
        <div>
          <div className="font-bold text-red-500">Registration failed</div>
          <div>{error instanceof Error ? error.message : "Please try again later."}</div>
        </div>
      )
    } finally {
      setIsLoading(false)
    ...
    <div className="min-h-screen bg-white dark:bg-black text-black dark:text-white flex flex-col md:flex-row">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                className={`bg-white dark:bg-black border-black/20 dark:border-white/20 text-black dark:text-white ${errors.name ? "border-red-500" : ""}`}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={handleChange}
                className={`bg-white dark:bg-black border-black/20 dark:border-white/20 text-black dark:text-white ${errors.email ? "border-red-500" : ""}`}
              />
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={handleChange}
                className={`bg-white dark:bg-black border-black/20 dark:border-white/20 text-black dark:text-white ${errors.password ? "border-red-500" : ""}`}
              />
      ...
      <div className="hidden md:flex md:w-1/2 bg-black dark:bg-zinc-900 p-12 items-center justify-center">
        <div className="max-w-md text-center">
          ...
          <h2 className="text-2xl text-gray-200 font-bold mb-4">People who love us</h2>
          <p className="text-white/70 dark:text-white/70">
            Ventur is loved by thousands of people across the world, be part of the community and join us.
          </p>
        </div>
      </div>
    </div>
